( This is my favorite language, due to the simplicity of this )
( Prime @ https://rosettacode.org/wiki/AKS_test_for_primes#Forth )
( Started from https://rosettacode.org/wiki/Fibonacci_sequence#Forth )
            ...
            dup 5 mod 0= if
               ...
               dup 15 mod 0= if
                  ...
                  dup prime? if
                     ." BuzzFizz " else
                     dup .
      then then then then else dup . then
   loop drop ;

( However, I see there some bugs in this AKS algorithm )
